...
exports.allAccounts = async (req, res) => {
    try {
        ...
        for await (let account of accounts) {
            const user = await User.findById(account.customerID).exec();
            data.push({ ...account._doc, customerName: user.fullName, customerEmail: user.email, customerPhone: user.phone });
        }
